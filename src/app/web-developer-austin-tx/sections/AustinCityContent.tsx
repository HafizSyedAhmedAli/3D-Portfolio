        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-4 text-white/60 leading-relaxed text-sm md:text-base mb-8 md:mb-10">
            ...
            <p>
              ...
              TypeScript, Node.js, PostgreSQL, and Redis puts your project on
              the same level as what top Austin tech companies ship internally.
            </p>
            <p>
              I also cover the wider Texas market. Whether you&apos;re in
              Dallas, Houston, San Antonio, Fort Worth, Plano, or Frisco —
              remote collaboration means you get the same quality, just without
              the Austin agency price tag.
            </p>
          </div>
