...
import { glasgowPageData } from "@/constants/cityPagesUK";
import { generateCitySchemas } from "@/lib/seo/generateCitySchemas";
import { generateCityMetadata } from "@/lib/seo/generateCityMetadata";

export const metadata: Metadata = generateCityMetadata(glasgowPageData);

const schemas = generateCitySchemas(glasgowPageData);
...
export default function GlasgowPage() {
  return (
    <>
      ...
      <CityPageTemplate data={glasgowPageData} />
    </>
  );
}
