...
import { dallasServices } from "@/constants/dallas";
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <SectionHeading className="mb-10 md:mb-12">
          Web Development Services for Dallas TX Companies
        </SectionHeading>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          {dallasServices.map((service, index) => {
              ...
              >
                <div className="p-5 md:p-6">
                  ...
                  <button
                    ...
                    aria-controls={`dallas-service-details-${index}`}
                ...
                <div
                  id={`dallas-service-details-${index}`}
                  aria-hidden={!isOpen}
