...
import { houstonWhyCards } from "@/constants/houston";

const HoustonWhyChoose = () => (
  <section
    id="hire-me-houston"
  ...
  >
    <div className="max-w-7xl mx-auto">
      ...
      <SectionHeading className="mb-10 md:mb-12">
        Why Houston TX Businesses Choose Ahmed Ali
      </SectionHeading>

      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-5">
        {houstonWhyCards.map((item) => (
...
export default HoustonWhyChoose;
