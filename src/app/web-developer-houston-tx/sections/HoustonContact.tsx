...
import { houstonAvailability } from "@/constants/houston";
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4">
          Hire a Web Developer Houston TX Today
        </h2>
        <p className="text-white/60 text-base md:text-lg leading-relaxed mb-10 md:mb-12 max-w-2xl">
          Have a project in mind? Describe what you need and I&apos;ll respond
          within 24 hours with a free consultation — no commitment required.
        </p>
        ...
        <div className="mb-10 md:mb-12">
          ...
          <div className="rounded-2xl border border-white/8 overflow-hidden w-full">
            <iframe
              ...
              width="100%"
              height="600"
              title="Schedule a free consultation with Ahmed Ali – Web Developer Houston TX"
              className="w-full"
            />
          </div>
        </div>
        ...
        >
          ...
          <div className="relative rounded-2xl border border-white/8 bg-white/2 overflow-hidden">
            ...
            >
              ...
              <FloatInput
                id="houston-city"
                name="city"
                label="Your city (e.g. Houston TX)"
                value={form.city}
                onChange={handleChange}
                disabled={loading}
              />
          ...
          <div className="flex flex-col gap-4 md:gap-5">
            ...
            <AvailabilityPanel items={houstonAvailability} />
          </div>
        </div>
      </div>
    </section>
