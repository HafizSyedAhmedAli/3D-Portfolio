...
import { houstonServices } from "@/constants/houston";
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <SectionHeading className="mb-10 md:mb-12">
          Web Development Services for Houston TX Businesses
        </SectionHeading>
              ...
              >
                <div className="p-5 md:p-6">
                  ...
                  <button
                    ...
                    aria-controls={`houston-service-details-${index}`}
                ...
                <div
                  id={`houston-service-details-${index}`}
                  aria-hidden={!isOpen}
...
export default HoustonServices;
