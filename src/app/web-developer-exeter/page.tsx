...
import { exeterPageData } from "@/constants/cityPagesUK";
import { generateCitySchemas } from "@/lib/seo/generateCitySchemas";
import { generateCityMetadata } from "@/lib/seo/generateCityMetadata";

export const metadata: Metadata = generateCityMetadata(exeterPageData);

const schemas = generateCitySchemas(exeterPageData);
...
export default function ExeterPage() {
  return (
    <>
      ...
      <CityPageTemplate data={exeterPageData} />
    </>
  );
}
