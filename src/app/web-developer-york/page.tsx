...
import { yorkPageData } from "@/constants/cityPagesUK";
import { generateCitySchemas } from "@/lib/seo/generateCitySchemas";
import { generateCityMetadata } from "@/lib/seo/generateCityMetadata";

export const metadata: Metadata = generateCityMetadata(yorkPageData);
const schemas = generateCitySchemas(yorkPageData);
...
export default function YorkPage() {
  return (
    <>
      ...
      <CityPageTemplate data={yorkPageData} />
    </>
  );
}