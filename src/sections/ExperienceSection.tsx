...
const ExperienceSection = () => {
  useGSAP(() => {
    ...
    gsap.set(".experience-line-active", {
      height: 0,
    });
              ...
              return (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 xl:grid-cols-[0.95fr_1.05fr] gap-6 xl:gap-10 items-start">
                    ...
                    >
                      <div className="animate-item flex items-center justify-between gap-4 mb-6">
                    ...
                    <div className="expText pl-2 md:pl-6">
                      ...
                      <h1 className="animate-item font-semibold text-3xl md:text-5xl leading-tight">
                        {card.title}
                      </h1>
                      ...
                      <div className="mt-10 space-y-6">
                        {card.responsibilities.map((responsibility) => (
                          ...
                          >
                            <div className="mt-2.5 size-2 rounded-full bg-emerald-400 shadow-[0_0_12px_rgba(16,185,129,0.9)] group-hover:scale-125 transition-transform duration-300" />
